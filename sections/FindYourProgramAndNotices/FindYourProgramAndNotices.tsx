        ...
        <div className="relative bg-zinc-950 border border-zinc-800 rounded-sm overflow-hidden h-[420px] shadow-lg flex flex-col justify-end p-6 z-10 group">
          ...
          <div className="relative z-10 w-full px-4 md:px-8 pb-4">
            ...
            <div className="border-b border-zinc-700/60 pb-3 mb-6 group/item cursor-pointer">
              <Link
                href="#"
                className="text-xl md:text-[22px] font-bold text-white hover:text-[#52a8e8] transition-colors flex justify-between items-center leading-none"
              >
                <span>Undergraduate</span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 opacity-0 group-hover/item:opacity-100 transition-opacity text-[#52a8e8]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2.5}
      ...
      <div>
        ...
        <div className="bg-white border border-gray-200 flex flex-col h-[420px]">
          ...
          <div className="p-4 bg-gray-50 border-t border-gray-200 text-center">
            <Link
              href="#"
              className="text-[#0f4a8a] font-semibold text-sm hover:underline"
            >
              Browse All Notices
            </Link>
          </div>

    ...
    },
    {
      node: (
        <div className="flex items-center gap-2 font-bold text-[#003366] text-lg select-none">
          <svg className="w-5 h-6 flex-shrink-0 text-[#fbb034]" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" />
          </svg>
          <span className="font-serif tracking-tight">North South University</span>
        </div>
      )
    },
    {
      node: (
        <div className="flex items-center gap-1.5 font-bold text-[#006bb6] text-xl select-none">
          <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    },
    {
      node: (
        <div className="flex items-center gap-1 font-black text-xl select-none tracking-tighter">
          ...
          <svg className="w-5 h-5 ml-0.5 text-[#0f4a8a]" viewBox="0 0 24 24" fill="currentColor">
      ...
      node: (
        <div className="flex items-center gap-2 font-bold text-[#006a4e] text-lg select-none">
          ...
          <div className="relative flex items-center justify-center">
            <svg className="w-7 h-7 flex-shrink-0 text-[#f4a900]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 100-16 8 8 0 000 16z" />
            </svg>
            <svg className="w-3.5 h-3.5 absolute text-[#006a4e]" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div className="w-full border-t border-zinc-200 py-16 px-4 sm:px-6 lg:px-10">
      <div className="max-w-xl mx-auto flex justify-center items-center mb-10">
        <div className="flex items-baseline select-none relative font-sans tracking-normal leading-none">
            <h3 className='text-[1.5rem] md:text-[2rem] font-bold text-[#0f4a8a] uppercase ml-4 tracking-wider '>Educational Partners</h3>
        </div>
      </div>

                ...
                {campusItems.map((item, index) => (
                    <div
                        ...
                        className={`absolute inset-0 transition-opacity duration-700 ease-in-out ${
                            activeIndex === index ? "opacity-100 z-0" : "opacity-0 pointer-events-none"
                        }`}
                    >
                        <img 
                            src={item.img} 
                        ...
                        >
                          {/* Fresh white hovered text */}
                            <div className="flex flex-col items-center transition-transform duration-500 group-hover:-translate-y-2">
                                <span className={`font-sans font-medium text-lg tracking-wide [writing-mode:vertical-rl] rotate-180 select-none transition-all duration-300 ${
                                    activeIndex === index 

...
return (
    <section className="bg-white min-h-screen">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-around', background: '#ffffffff', color: 'black'}}>
      ...
      <div style={{ textAlign: 'center' }}>
        <h2 className='text-4xl font-bold hover:text-[#6cbafc] transition-all duration-300'>
          <CountUp end={41226} separator="," duration={2.5} enableScrollSpy scrollSpyOnce />
        </h2>
        <p className='text-2xl font-bold'>Total Graduates</p>
      </div>
      <div style={{ textAlign: 'center' }}>
        <h2 className='text-4xl font-bold hover:text-[#6cbafc] transition-all duration-300'>
          <CountUp end={23} separator="," duration={2.5} enableScrollSpy scrollSpyOnce />
        </h2>

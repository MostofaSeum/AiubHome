    ...
    <footer className="bg-[#1a1a1a] text-gray-400 pt-16 pb-8 border-t-[5px] border-[#0f4a8a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        <div className="md:col-span-2">
          ...
          <p className="text-sm leading-relaxed max-w-md pl-50 pt-3">
            404/3, Kuratoli, Khilkhet,
            <br />
            Dhaka 1229, Bangladesh
            <br />
            <br />
            <strong>Email:</strong> info@aiub.edu
            <br />
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li>
              <Link href="#" className="hover:text-[#0f4a8a] transition-colors">
                Future Students
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li>
              <Link href="#" className="hover:text-[#0f4a8a] transition-colors">
                Faculty of Science and Technlogoy
              </Link>
            </li>
            <li>
              <Link href="#" className="hover:text-[#0f4a8a] transition-colors">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs">
          <p>
            © {new Date().getFullYear()} American International
          ...
          <p>
            ...
            <Link
              ...
              target="_blank"
              className="hover:text-[#0f4a8a] transition-colors"
            >
